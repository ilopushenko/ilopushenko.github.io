...
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
	    <h5 class="card-title">Supervision activities</h5>
		...
		<h6 class="card-subtitle font-italic">Co-supervision of PhD and MSc students within <a href="https://www.oulu.fi/en/projects/novel-research-instrument-for-measuring-vascular-health" target="_blank" rel="noopener noreferrer">FLOW! project at Biocenter Oulu.</a></h6>
        <h6 class="card-subtitle font-italic">Co-supervision of <a href="https://www.nature.com/articles/s41598-024-70954-x" target="_blank" rel="noopener noreferrer">PhD students from Aston University.</a></h6>
      </div>
	  <!-- 
...
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
		<h5 class="card-title"><a href="https://moodle.oulu.fi/course/view.php?id=30930" target="_blank" rel="noopener noreferrer">521124S: Electronic Sensors</a></h5>
        ...
        <!-- <h5 class="card-title"><a href="https://moodle.oulu.fi/enrol/index.php?id=11006" target="_blank" rel="noopener noreferrer">521124S: Electronic Sensors</a></h5> -->
		<!-- <h5 class="card-title"><a href="https://opas.peppi.oulu.fi/en/course/521124S/991?period=2024-2025" target="_blank" rel="noopener noreferrer">521124S: Electronic Sensors</a></h5> -->
        <h6 class="card-subtitle font-italic">Years 2024-2026: teacher (seminar/exercise classes).</h6>
      </div>
	  <!-- 
      <div class="col-sm-2 text-sm-right">
        <span class="badge">
  ...
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
        ...
        <!-- <h5 class="card-title"><a href="https://moodle.oulu.fi/enrol/index.php?id=11006" target="_blank" rel="noopener noreferrer">521124S: Electronic Sensors</a></h5> -->
		<!-- <h5 class="card-title"><a href="https://opas.peppi.oulu.fi/en/course/521124S/991?period=2024-2025" target="_blank" rel="noopener noreferrer">521124S: Electronic Sensors</a></h5> -->
		<h6 class="card-subtitle font-italic">Years 2018-2019: Supervising <a href="https://istina.msu.ru/diplomas/coursework/241696402/" target="_blank" rel="noopener noreferrer">BSc student at Faculty of Physics, Chair of Mathematics</a>.</h6>
		<h6 class="card-subtitle font-italic">Years 2016-2018: Supervising projects of high school students in programming for Android devices (see Samsung IT Schoool below).</h6>
      </div>
	  <!-- 
      <div class="col-sm-2 text-sm-right">
        <span class="badge">
